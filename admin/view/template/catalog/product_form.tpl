  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> <?php echo $text_form; ?></h3><br/>
		<h3 class="panel-title">
		<?php if($product_id){ ?>
			<?php echo 'ID - товара: ' . $product_id  ?>
		<?php } ?>
                        ...
                        <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
							  ...
							  <td class="text-right"><div class="link_product_id"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][link_product_id]" value="<?php echo $product_option_value['link_product_id']; ?>" placeholder="ID-товара" class="form-control" /></div></td>
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
			...
			html += '        <td class="text-right">ID-товара для опции "Выбор цвета":</td>';
...
function addOptionValue(option_row) {
	...
	html += '  <td class="text-right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][link_product_id]" value="" placeholder="ID-товара" class="form-control" /></td>';

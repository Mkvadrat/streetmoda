                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
					  ...
					  <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-fax">Whatsapp</label>
                        <div class="col-sm-10">
                          <input type="text" name="whatsapp" value="<?php echo $whatsapp; ?>" placeholder="Whatsapp" id="input-fax" class="form-control" />
                        </div>
                      </div>
			          <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-fax">Viber</label>
                        <div class="col-sm-10">
                          <input type="text" name="viber" value="<?php echo $viber; ?>" placeholder="Viber" id="input-fax" class="form-control" />
                        </div>
                      </div>
			          <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-fax">Skype</label>
                        <div class="col-sm-10">
                          <input type="text" name="skype" value="<?php echo $skype; ?>" placeholder="Skype" id="input-fax" class="form-control" />
                        </div>
                      </div>

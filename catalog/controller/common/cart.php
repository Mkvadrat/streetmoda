...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		$data['text_value'] =  sprintf($this->language->get('text_value'), $this->cart->countProducts() + (isset($this->session->data['vouchers']) ? count($this->session->data['vouchers']) : 0), $this->currency->format($total, $currency = 'RUB'));
